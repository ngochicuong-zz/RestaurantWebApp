...
public interface ISeatTableService{
	...
	SeatTable createSeatTable(int floor, int room,	 int capacity, int priority, String description);
	boolean updateSeatTable(int seatId, int floor, int room, int capacity, int priority, String description);
}
